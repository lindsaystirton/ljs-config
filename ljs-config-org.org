...
(defun ljs/display-pdf-to-right (buffer alist)
  "Display PDF files (from LaTeX, Org, or anywhere else) in a side
window on the right, doubling the frame width to make room.
...
triggered it from."
  (setq ljs/original-frame-width (frame-pixel-width (window-frame (selected-window))))
